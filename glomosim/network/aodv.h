...
//////////////////////////////////////////////////////
	...
	int thru;
//////////////////////////////////////////////////////
	//A pointer pointing to DRI table	
} AODV_RREP_Packet;
...
/////////////////////////////////
	AODV_DRI driTable;
	AODV_BLACKH blkTable;
////AODV_FQST FREQseenTable;  
////AODV_FPST FREPseenTable;  
/////////////////////////////////
    AODV_RST seenTable;
    AODV_BUFFER buffer;
    AODV_SENT sent;
...
void RoutingAodvInitDriTable(AODV_DRI *driTable);

void RoutingAodvInsertDRITablefrom(Message *msg,AODV_DRI *driTable,NODE_ADDR srcAddr,NODE_ADDR destAddr,NODE_ADDR chkAddr,AODV_RT *routeTable);

void RoutingAodvInsertDRITablethru(Message *msg,AODV_DRI *driTable,NODE_ADDR srcAddr,NODE_ADDR destAddr,NODE_ADDR chkAddr,AODV_RT *routeTable,NODE_ADDR thruAddr);

void PrintDRI(AODV_DRI *driTable,NODE_ADDR srcAddr);

void PrintRTE(AODV_RT *routeTable,NODE_ADDR srcAddr);

int getfromvalofDRI(AODV_DRI *driTable,NODE_ADDR chkAddr);

int getthruvalofDRI(AODV_DRI *driTable,NODE_ADDR chkAddr);

void RoutingAodvHandleACK(GlomoNode *node, Message *msg, NODE_ADDR srcAddr, NODE_ADDR destAddr);

void RoutingAodvInitiateACK(GlomoNode *node, NODE_ADDR thruAddr,NODE_ADDR destAddr);

void RoutingAodvInsertBLACKTable(Message *msg,AODV_BLACKH *blkTable,NODE_ADDR srcAddr,NODE_ADDR destAddr,NODE_ADDR chkAddr,AODV_RT *routeTable,NODE_ADDR blkAddr);

void RoutingAodvHandleBLACK(GlomoNode *node, Message *msg, NODE_ADDR srcAddr, NODE_ADDR destAddr);

void RoutingAodvInitiateBLACK(GlomoNode *node, NODE_ADDR blkAddr,NODE_ADDR destAddr);

void RoutingAodvInitBLACKTable(AODV_BLACKH *blkTable);

BOOL chkBLACKnode(NODE_ADDR chkAddr,AODV_BLACKH *blkTable);
